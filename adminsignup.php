...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if($password==$confirmpassword){
       ...
       if($mail){
           ...
           $sql = "INSERT INTO `registration` (`ongc_regno`, `admin_name`, `email`, `password`, `contact_no`,`otp`, `timestap`) VALUES ('$ongc_regno', '$admin_name', '$email', '$hashpassword', '$contact_no','$otp', current_timestamp())";
           ...
           header("location: verify.php?ongc=".$ongc_regno);
              exit;
...
?>
    ...
    <div class="container">
        <form action="/projects/adminsignup.php" method="post">
