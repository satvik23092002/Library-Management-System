...
if(isset($_SESSION['user_name'])){
  ...
  if($num==1){
    ...
    echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="userbook.php">Home</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="userbook.php">Books</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="usermain.php">Thesis</a></li>
                <li><hr class="dropdown-divider"></li>
          ...
          <span class="my-0 py-0" style="font-size:30px;">&#128269;</span>
            ...
            <ul class="navbar-nav me-auto  mb-2 mb-lg-0">
             <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
               <img src="'.$pic.'" alt="profile" srcset=""> <small>'.$user.'</small>
              </a>
              <ul class="dropdown-menu">
      ...
      <strong>congrats!</strong> There is Some Error in _navbar.php
  ...
  $sql="SELECT * FROM `registration` WHERE `admin_name`='$user'";
  $result = mysqli_query($conn, $sql);
  $num= mysqli_num_rows($result);
  if($num==1){
  $row=mysqli_fetch_assoc($result);
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="main.php">Thesis</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="newspaper.php">Newspaper</a></li>
            </ul>
          </li>
