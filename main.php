...
<body>
    ...
    <div id="Thesis" class="tabcontent">
        <h1 class="heading">Thesis For You</h1>
    ...
    <div id="AddThesis" class="tabcontent">
        <?php
             if($_SERVER['REQUEST_METHOD']=='POST'){
                 $Thesis_name = $_POST['name'];
                 $Thesis_author_name=$_POST['Authorname'];
                 $Thesis_desc = $_POST['Thesis_desc'];
             
             $sql="INSERT INTO `thesis` ( `thesis_name`, `thesis_author_name`, `thesis_desc`, `timestamp`) VALUES ( '$Thesis_name', '$Thesis_author_name', '$Thesis_desc', current_timestamp());";
             $result=mysqli_query($conn,$sql);
             if($result){
                 echo '<div class="alert alert-success alert-dismissible fade show mt-0" role="alert">
                 <strong> Success!</strong> Thesis hasbeen Added Successfully.
                 ...
                 <strong>Sorry!</strong> Thesis didn\'t Added Successfully.
                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                 </button>
                 </div>';
        ...
        <div class="container">
            <form action="/projects/main.php" method="post">
                ...
                <input type="name" name="Authorname" id="Authorname" placeholder="Thesis Author Name" required><br>
                <!-- <label for="desc">Enter Description</label> -->
                <textarea name="Thesis_desc" id="" cols="70" rows="5" placeholder="Thesis Description"
                required></textarea><br>
                <button class="add" type="submit">Add </button><br>
